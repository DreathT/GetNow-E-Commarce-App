    ...
    <div>
        <nav className="navbar row">
            <div className="col-12 col-md-3 ps-5">
                ...
                <a href="/">
                    <img src="/images/GetNow.png" alt="GetNow Logo" />
                </a>
                </div>
            </div>
            ...
            {user ? (
                <div className="ms-4 dropdown">
                    ...
                    <div className="dropdown-menu w-100" aria-labelledby="dropDownMenuButton">
                        ...
                        <Link className="dropdown-item" to={"/self/orders"}> Orders </Link>

                        <Link className="dropdown-item" to={"/self/profile"}> Profile </Link>
